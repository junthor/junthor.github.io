...
export class DocumentConfig {
    constructor(stylist, title, margin) {
        ...
        this.window = new DraggableWindow('config-app', 'Document Settings');
        ...
        this.column_left = this.window.create_column(this.categories);
        this.window.get_container().appendChild(this.column_left);
        this.window.get_container().appendChild(this.general_tab);
