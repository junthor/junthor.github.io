const GUIDE_AUTOLOAD = {
  ...
  style: {
    ...
    ".banner.simple": {
      "background-image": "url('./styles/banner_simple.svg')",
    },
    ".banner.ribbon": {
      "background-image": "url('./styles/banner_ribbon.svg')",
    },
    ...
    th: { "font-family": "var(--table-font)", padding: "2px 4px" },
    td: { "font-family": "var(--table-font)", padding: "2px 4px" },
    p: { margin: "0" },
    ".text": { margin: "0", padding: "0", "text-align": "justify" },
    ".page:nth-child(odd) .page-number": { right: "20px", left: "unset" },
    ".page-number": {
      position: "absolute",
      left: "20px",
      bottom: "30px",
    ...
    "* + .note": { "margin-top": "calc(var(--space-between) * 2)!important" },
    ".note": {
      "break-inside": "avoid",
    ...
    ".description": {
      ...
      "border-width": "7px",
      "border-image":
        'url("./styles/borders/description.svg") 24% 17.5% stretch',
    ...
    "blockquote ul": { "list-style-type": "none", "margin-top": "0.4em" },
